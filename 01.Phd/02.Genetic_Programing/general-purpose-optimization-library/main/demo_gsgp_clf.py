"""A simple demonstration of how to solve a classification problem
...
def main():
    ...
    from gpol.utils.utils import prm_asigmoid_rmse, train_test_split
    ...
    pi = SMLGS(sspace=sspace, ffunction=prm_asigmoid_rmse(a=0.5), X=X, y=y, train_indices=train_indices,
