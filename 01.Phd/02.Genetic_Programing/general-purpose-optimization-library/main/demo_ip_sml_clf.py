def main():
    ...
    from gpol.utils.datasets import load_breast_cancer
    ...
    from gpol.utils.utils import train_test_split, prm_asigmoid_rmse
    ...
    # Creates problem's instance (PI)
    pi = SML(sspace, prm_asigmoid_rmse(a=0.5), dl_train, dl_test, min_=True)

    # ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    # > > >´Defines algorithms' parameters
    pop_size, n_iter = 100, 20
    ...
    for isa_type, isa_pars in pars.items():
        ...
        # Solves the PI
        isa.solve(n_iter=n_iter, tol=0.01, n_iter_tol=5, test_elite=True, verbose=2, log=0)
